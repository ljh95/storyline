...
function modalreset() {
  ...
  modal_storydel = $("#storydel");
  modal_storydel.hide(0)
...
function modalimgIn() {
  ...
  if (oldimg != null) {
    ...
    modal_imgchange.attr('src', "img/img.svg");
  }
...
function storydelIn(id) {
  ...
  modal_storydel.show(100)
}

function storydelOut() {
  delid = null
  modal_Layer.css({
    'top': '-100%',
  });
...
function load_story(position, id, title, name, summary, image) {
  ...
  create_StoryHTML += title + '</div> </div> <div class="StorysRight"> <div class="StoryDelBut" onClick="storydelIn(' + id + ')"> 삭제하기 </div> </div> </div> <div class="StorysBottom"> <div class="StorySummary"> ';
